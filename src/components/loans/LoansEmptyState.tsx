...
export const LoansEmptyState: FC<LoansEmptyStateProps> = ({
  ...
  return (
    <div
      data-test="loans-empty-state"
      className="flex flex-col items-start gap-4 rounded-lg border border-dashed border-slate-200 bg-slate-50 p-6 text-sm text-slate-600"
    >
      ...
      <Button
        type="button"
        data-test="loans-empty-state-add-button"
        onClick={onAdd}
