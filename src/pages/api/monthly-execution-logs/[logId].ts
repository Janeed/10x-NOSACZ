...
import { patchLog } from "../../../lib/services/monthlyExecutionLogService.ts";
import { patchMonthlyExecutionLogSchema } from "../../../lib/validation/monthlyExecutionLog.ts";
...
export const PATCH: APIRoute = async ({ locals, request, params }) => {
  ...
  try {
    ...
    logger.error(
      "monthly_execution_logs_patch",
      "Failed to patch monthly execution log",
      {
